...
- coseyfannitutti's custom bootloader:   
https://github.com/coseyfannitutti/USBaspLoader/tree/atmega32a
  - Please ensure you are in the atmega32a branch of coseyfannitutti's fork of the USBaspLoader repository when downloading.
  ...
  - Makefile.inc sets flashing device as usbtiny, as it is used with a sparkfun pocket avr programmer. If you need to use another programmer please edit line 41 of Makefile.inc accordingly. Only edit Makefile.inc, and NEVER directly edit the actual Makefile.
